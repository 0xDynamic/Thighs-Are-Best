...
(function () {
    ...
    $(document).ready(function () {
        var links = [
                {
                    name: 'The Moe Loli King',
                    link: '662753664435486739'
                },
        ...
        for (var i in links) {
            ...
            $('#marquee').append('<a href="https://profiles.pw/profile/' + link.link + '" target="_BLANK">' + link.name + '</a>');
    ...
    (function () {
        $.getJSON('https://api.ipgeolocation.io/ipgeo?apiKey=436b67cfc7d14736b3a80287e6f81dcf', function (data) {
            ...
            writeLine(["Authenticating...", "Granting access to <span style='font-size: 14px; color: #06d;'>[Unknown]</span>..."], 30, function () {
                ...
                writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[Success]</span>", "Welcome back, Random Skiddo with this hilarious IP " + ip + "</i>! By the way, nice to see someone from " + ((data.country_name) ? data.country_name : 'your country') + " here!"], 30, 500, function () {
                    ...
                    writeLine(["<i style='color: #F62459'>Rosery Team</i>"], 120, 500, function () {
